...
import com.thelazydaniel.taskflow.auth.service.TokenBlackListService;
        ...
        try {
            ...
            if (jwt != null) {
                if (tokenBlackListService.isTokenBlacklisted(jwt)){
                    sendErrorResponse(request,response,"Token has been revoked");
                    return;
                }

                if (jwtTokenProvider.validateToken(jwt, TokenType.ACCESS).isValid()) {
